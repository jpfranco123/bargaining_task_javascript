...
function RecordRTC(mediaStream, config) {
    ...
    //123 timeCallback
    function startRecording(timeCallback123) {
    ...
    //123
    function initRecorder(initCallback,timeCallback123) {
        if (!config.disableLogs) {
        ...
        mediaRecorder.record(timeCallback123);
...
function WhammyRecorder(mediaStream, config) {
     ...
     */
     //123
    this.record = function(timeCallback123) {
        if (!config.width) {
            config.width = 320;
        }
